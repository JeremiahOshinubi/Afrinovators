from afrinovators import app
from afrinovators.models import Users, Posts, Contact
from afrinovators.forms import RegisterForm, LoginForm, PostForm, EditForm, ContactForm
from afrinovators import db
